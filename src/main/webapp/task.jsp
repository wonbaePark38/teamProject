					...
					<div id="contents_container">
						<div class="work_table">
							<table class="table_list" name="${user.name}">
								...
								<c:forEach var="totalTaskList" items="${totalTaskList}">
									<tr id="task_board" class="taid" name="${totalTaskList.article_id}">
										<td><span>${totalTaskList.writeForm3_tasknum}</span></td>
										<c:choose>
											<c:when test="${totalTaskList.writeForm3_status eq '요청'}">
												<td><a class="tstatus" style="background-color: #4aaefb;">${totalTaskList.writeForm3_status}</a></td>
											</c:when>
											<c:when test="${totalTaskList.writeForm3_status eq '진행'}">
												<td><a class="tstatus" style="background-color: #50b766;">${totalTaskList.writeForm3_status}</a></td>
											</c:when>
											<c:when test="${totalTaskList.writeForm3_status eq '피드백'}">
												<td><a class="tstatus" style="background-color: #f17a19;">${totalTaskList.writeForm3_status}</a></td>
											</c:when>
											<c:when test="${totalTaskList.writeForm3_status eq '완료'}">
												<td><a class="tstatus" style="background-color: #2e417e;">${totalTaskList.writeForm3_status}</a></td>
											</c:when>
											<c:when test="${totalTaskList.writeForm3_status eq '보류'}">
												<td><a class="tstatus" style="background-color: #aeaeae;">${totalTaskList.writeForm3_status}</a></td>
											</c:when>
										</c:choose>
										<c:choose>
										...
										<c:choose>
											<c:when test="${totalTaskList.writeForm3_title ne null}">
												<td><a id="task_board" class="task_title" name="${totalTaskList.article_id}">${totalTaskList.writeForm3_title}</a></td>
											</c:when>
											<c:when test="${totalTaskList.writeForm3_title eq null}">
												<td><a id="task_board" class="task_title" name="${totalTaskList.article_id}">-</a></td>
											</c:when>
										</c:choose>
