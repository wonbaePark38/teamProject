...
<body>
	...
	<div class="post_idx"style="width: 511px;  background-color: pink;">
		...
		<div class="top_writer"
			style="display: inline-block; width: 474px; height: 60px; padding: 25px 12px 0px 25px; background-color: pink;">
		...
		<!-- 글내용 -->
		<div class="post"style="padding: 7px 25px; border-bottom: 1px solid #eaeaea;">
