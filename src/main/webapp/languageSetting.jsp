		...
		<div class="centerArea">
			...
			<div class="article">
				...
				<div class="small-text">
					플로우에서 사용할 언어를 선택하십시오. <span class="present-language"></span> 로 설정되어
					있습니다.
				</div>
				...
				<div class="timezone-setting-div">
					...
					<select id="timezone-select">
						...
						<option value="korean">(UTC -08:00) 미국 LA(Los Angeles,
							USA), DST</option>
						<option value="korean">(UTC -05:00) 미국 뉴욕(New York, USA),
							DST</option>
						<option value="korean">(UTC +08:00) 싱가폴(Singapole),
							필리핀(Philippines)</option>
					</select>
				</div>

				<div class="small-text">
					플로우는 타임존을 사용하여 타임라인 내 등록되어 있는 글과 댓글에 시간을 표기하며 신규 알림을 발송합니다.<br />
